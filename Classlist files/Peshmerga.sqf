//[this, "Pesh_SL"] call FNC_GearScript;
//[this, "Pesh_TL"] call FNC_GearScript;
//[this, "Pesh_AR"] call FNC_GearScript;
//[this, "Pesh_MD"] call FNC_GearScript;
//[this, "Pesh_RF"] call FNC_GearScript;
//[this, "Pesh_RFAT"] call FNC_GearScript;
// Sniper is _SN and AT assistant is _RFATA;


#define package "Pesh_"

#define uniform \
	["usm_bdu_w"] call FNC_AddItem; \
	["rhs_6b26_green"] call FNC_AddItem;
...
#define muzzle \
	...
	["rhs_acc_2dpZenit", 1, "vest"] call FNC_AddItem;
	
case (package + "SL"): {
	
	uniform;
	
	["rhsusf_falconii_mc", "rhsusf_falconii"] call FNC_AddItemRandom; //back
...
case (package + "AR"): {
	...
	["CORX_Kitbag_multicam", "CORX_Kitbag_6CDesert"] call FNC_AddItemRandom; //back
...
case (package + "MD"): { // ATTENTION NOT FINISHED, NEED MEDIC BACKPACK
	
	uniform;
	IFAK;
	items;
	
	["tin_backpack_medic_tan"] call FNC_AddItem;
